 ...
 *  Course CS1011-051
 *  Fall 2020-2021
 *  House purpose: Makes use of the BuildingCostEstimator class to estimate the cost of building two houses based on the user's desires.
 *  @author Parker
 *  @version created on 10/14/2020 at 10:52 AM
 */
